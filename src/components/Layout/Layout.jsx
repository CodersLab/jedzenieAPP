          ...
          <div className="column is-one-fifth">
            <aside className="menu" style={{marginRight: "4rem", marginTop: "1rem"}}>
              ...
              <ul className="menu-list">
                <li><NavLink to={"/"} exact="true" activeclassname={"is-active"}>Strona główna</NavLink></li>
                <li><NavLink to={"/recipes"} exact="true" activeclassname={"is-active"}>Przepisy</NavLink></li>
                <li><NavLink to={"/products"} exact="true" activeclassname={"is-active"}>Produkty</NavLink></li>
              </ul>
              <p className="menu-label">
                Akcje
              </p>
